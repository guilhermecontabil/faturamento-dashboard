...
# Remover o DAS da tabela de outros impostos para evitar duplicidade
...
st.dataframe(df_impostos[~df_impostos['Historico'].str.contains('DAS', case=False, na=False)].style.format({'Valor_Pagar': 'R$ {:,.2f}'}))
